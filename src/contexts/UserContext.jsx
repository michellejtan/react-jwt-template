...
function UserProvider({ children }) {
    ...
    // (1)Create state just like you normally would in any other component
    // (2) call getUserFromToken() to get our initial user state, instead of null now, reading from localstorage
